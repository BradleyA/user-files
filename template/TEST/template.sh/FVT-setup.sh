#!/bin/bash
# 	template/TEST/template.sh/FVT-setup.sh  3.500.755  2019-09-05T12:51:50.940863-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.499  
