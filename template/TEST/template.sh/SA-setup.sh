#!/bin/bash
# 	template/TEST/template.sh/SAST-setup.sh  3.492.747  2019-09-01T00:09:00.320709-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.491  
