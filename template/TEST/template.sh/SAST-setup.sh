#!/bin/bash
# 	template/TEST/template.sh/SAST-setup.sh  3.438.685  2019-08-22T23:38:37.647191-05:00 (CDT)  https://github.com/BradleyA/user-files.git  uadmin  one-rpi3b.cptx86.com 3.437  
